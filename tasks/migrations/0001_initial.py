    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(max_length=254, upload_to=tasks.models.upload_directory_path),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "permission",
                    models.CharField(choices=[("R", "Чтение"), ("W", "Запись")], max_length=10),
                ),
                (
                    "group",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tags",
                    models.ManyToManyField(db_table="tasks_tags_m2m", related_name="tasks", to="tasks.tag"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "address",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="tasks.address"),
                ),
                (
                    "files",
                    models.ManyToManyField(
